 ...
 * @author jtyhr
 */
public class frmVnetana extends javax.swing.JFrame {
    modelTabla modelo = new modelTabla();

    /**
     * Creates new form frmVnetana
     */
    public frmVnetana() {
        initComponents();
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        ...
        p.setX(Double.parseDouble(this.txtx.getText().trim()));
        
        p.setY(Double.parseDouble(this.txty.getText().trim()));
        
        System.out.println(p.toString());
        
        this.modelo.addPunto(p);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVnetana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVnetana().setVisible(true);
            }
        });
    }
